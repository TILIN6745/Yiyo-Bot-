...
description = official[0][0] == String(contact[0]) ? 'Solo temas de yiyibot' : official[1][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[2][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[3][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : desc === '' ? lenguajeGB.smsContacto5() : desc
...
lugar = official[0][0] == String(contact[0]) ? 'yiyi' : official[1][0] == String(contact[0]) ? 'yiyi' : official[2][0] == String(contact[0]) ? 'yiyi' : official[3][0] == String(contact[0]) ? 'yiyi' : country === '' ? lenguajeGB.smsContacto7() : country
enlace = official[0][0] == String(contact[0]) ? 'yiyi' : official[1][0] == String(contact[0]) ? 'yiyi' : official[2][0] == String(contact[0]) ? 'yiyi' : official[3][0] == String(contact[0]) ? 'yiyi' : md 
...
await conn.sendFile(m.chat, pp, 'lp.jpg', cat, fkontak, false, { contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '𝗬𝗜𝗬𝗜𝗕𝗢𝗧, previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb.getRandom()}}})
